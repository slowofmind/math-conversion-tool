...
\begin{center}
  \large\textsc{Problem Set 12 - Using Derivatives to Graph Functions}
\end{center}
...
\item  In this problem, both \ref{deriv-of-ax^3+bx} and \href{https://people.math.harvard.edu/~jjchen/mathma/docs/homework/PS10.html}{Problem Set 10}, {{{{\#3}}(a)}} will be useful.
...
\item \label{limit-intro} 
  ...
  We've seen that the definition of the derivative involves the idea of a limit. Next class, we'll start a deeper dive into the idea of a limit. To prepare, please read \href{https://people.math.harvard.edu/~jjchen/mathma/handouts/limits.html}{the ``A Brief Introduction to Limits'' handout}, and then do the following problem.
  ...
  \item
    ...
    \begin{problem}[\vfill]
      $f$ is a function that you know how to graph. Graph it, explaining how you got the graph. (\emph{Hint:} If you're stuck, look back at {{\#4}} on \href{https://people.math.harvard.edu/~jjchen/mathma/docs/worksheets/worksheet02-sols.html}{the worksheet ``A Library of Basic Functions and Properties''}.) 
    \end{problem}
