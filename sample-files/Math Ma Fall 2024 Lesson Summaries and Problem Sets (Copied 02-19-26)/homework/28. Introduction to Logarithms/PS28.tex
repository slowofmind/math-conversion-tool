...
\begin{center}
  \large\textsc{Problem Set 28 - Inverse Functions}
\end{center}
...
\item 
  ...
  \item
    ...
    \begin{problem}[\vfill]
      Explain how you know $f$ is invertible. Then sketch the graph of $f^{-1}$ on the axes in (a). Label two points on the graph of $f^{-1}$.
    \end{problem}
