...
\begin{center}
  \large\textsc{Problem Set 5 - Linear and Piecewise Linear Functions}
\end{center}
...
\item % 4.3.1
  ...
  \emph{Note:} If you aren't familiar with the difference between \emph{revenue} and \emph{profit}, please read the first paragraph of Example 3.1 on pg. 101 of \href{https://people.math.harvard.edu/~jjchen/mathma/docs/handouts/Gottlieb.html}{Gottlieb}.
