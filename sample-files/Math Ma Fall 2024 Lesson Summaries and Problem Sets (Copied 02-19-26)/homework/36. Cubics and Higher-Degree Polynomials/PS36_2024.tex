...
\begin{center}
  \large\textsc{Problem Set 36 - Cubics and Higher-Degree Polynomials}\vspace{.5in}\\
  \begin{problemonly}
   \large Name: \rule{5cm}{0.15mm}\\
   \end{problemonly}
\end{center}

\probonly{\emph{Note:} This is the penultimate problem set!}
...
\newpage
\item 
{\bf The final exam is on Thursday 12/12.} Please read  \href{https://canvas.harvard.edu/courses/138327/pages/exams}{the information on Canvas about the exam}. In this problem, you'll make a rough study schedule like you did for the midterm exams.\\
 ...
 \begin{enumerate}
  \item
    ...
    \begin{problem}[\vfill\newpage]
      First, make a to-do list of everything you’d like to do to prepare for the exam, and write your list below. This is likely going to be too long, so identify which items are Must Dos and which are things you'll do only if you have time. Note: there are 4 practice exams and we recommend doing at least 3.
  ...
  \item
    ...
    \begin{problem}[\vfill\newpage]
      Now, look ahead at your calendar, and lay the tasks from your to-do list into your schedule in reverse order, working backwards from our exam date (Thursday 12/12). 
      A few tips:
      \begin{itemize}[nosep]
      \item Try not to put tasks on the test date. You can dip into the test date as an emergency, but not as your plan.
      \item Because our exam lands early in Finals Period, you should prioritize studying a bit everyday rather than taking days off. 
...
\newpage
\psreflection{For next class, read \href{https://canvas.harvard.edu/files/20608908/download?download_frd=1}{\S 11.6 of \emph{Functions Modeling Change} by Connally et. al}.}
\end{document}
