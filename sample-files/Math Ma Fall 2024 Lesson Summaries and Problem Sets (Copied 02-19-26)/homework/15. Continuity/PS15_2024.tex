...
\begin{center}
  \large\textsc{Problem Set 15 - Continuity}\vspace{.5in}\\
  \begin{problemonly}
...
\end{enumerate}
\psreflection{For next class, read \href{https://canvas.harvard.edu/courses/138327/files/20608912?wrap=1}{\S 3.1 of \emph{Calculus} by Hughes-Hallett et. al} through Example 4.}
\end{document}
