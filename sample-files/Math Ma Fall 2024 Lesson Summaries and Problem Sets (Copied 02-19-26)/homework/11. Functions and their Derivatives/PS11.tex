...
\begin{center}
  \large\textsc{Problem Set 11 - Functions and their Derivatives}
\end{center}
  ...
  \item
    ...
    \begin{problem}[\vfill]
      ...
      \begin{center}
        ...
        \end{tikzpicture}
      \end{center}
      For this time interval, sketch a rough graph of $f'(t)$. We don't have enough information to get a super accurate graph, but aim for the right qualitative behavior.
    \end{problem}
...
\item  Exam 1 is on Thursday 10/12. Please read \href{https://canvas.harvard.edu/courses/125618/pages/exams}{the information on Canvas about the exam}, as well as this \href{https://people.math.harvard.edu/~jjchen/mathma/sample-study-plan.html}{sample study plan}.
  ...
  \item
    ...
    \begin{problem}[\vfill\newpage]
      ...
      \begin{itemize}[nosep]
      \item Thursday 10/12: Test day!
      \item Wednesday 10/11: Go to office hours with final questions
      \item Tuesday 10/10: Nothing
      \item Monday 10/9: Take practice exam 2 and review
      \item Sunday 10/8: Go to MQC with questions from practice exam 1
      \item Saturday 10/7: Check practice exam 1 work against solutions, review topics that were difficult
      \item Friday 10/6: Take practice exam 1
      \end{itemize}
      A few tips:
      \begin{itemize}[nosep]
