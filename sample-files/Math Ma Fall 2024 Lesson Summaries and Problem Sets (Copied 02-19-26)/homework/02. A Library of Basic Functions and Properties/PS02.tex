...
\item 
  ...
  As you saw in the tips, we encourage you to discuss the material and problem sets with others. Here's a \href{https://people.math.harvard.edu/~jjchen/mathma/talk-math.html}{reminder of some ways to find others to talk math with}. In the next week or so, please either talk with someone at the MQC or office hours, or get together with at least one other student outside of class. We'll ask you to write a little about your experience on Problem Set 6 (due Wednesday 9/20) and to share in class, so that you can hear from your peers about what different resources are like.
...
\item \label{mini-exam-heads-up}
  ...
  The mini-exam is on Thursday 9/21. This is a chance for you to practice studying for an exam while the amount of material is still relatively low. Time management is important when an exam is coming up, as you'll want to balance learning new material with preparing for the exam. 

  The most important part of preparing for an exam is to do some practice exams! So, next week, we'll ask you to do Practice Mini-Exam 1; it's officially due on Friday 9/15 with Problem Set 4, but we'll allow you to turn it in any time before 8:30 am on Sunday 9/17 just to give you some additional flexibility.
