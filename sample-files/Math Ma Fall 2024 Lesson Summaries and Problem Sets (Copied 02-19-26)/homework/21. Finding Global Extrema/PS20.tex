...
\begin{center}
  \large\textsc{Problem Set 20 - Finding Global Extrema}
\end{center}
...
\item  
  ...
  \item
    ...
    \begin{grading}
      \begin{itemize}[nosep]
      \item 1 for calculating $g'$ correctly
    ...
    \begin{solution}
      ...
      \begin{align*}
        ...
        f'(3) &= \frac{-2(\text{pos})(\text{pos})(\text{pos})(\text{pos})}{\text{positive}}
          = \text{negative} \\
      \end{align*}
      Now we can draw a sign chart for $g'(t)$. 
...
\psreflection{For next class, read \href{https://people.math.harvard.edu/~jjchen/mathma/docs/handouts/Hughes-Hallet-4-3.html}{\S 4.3 of \emph{Calculus} by Hughes-Hallett et. al} through Example 4 but skipping Example 2.}
\end{document}
