...
\begin{center}
  \large\textsc{Problem Set 10 - The Derivative Function}\\\vspace{.5in}
  \begin{problemonly}
...
\item  
  ...
  \item \label{shifted-quadratic-positive-derivative}
    ...
    \begin{problem}[\nstretch{0.5}]
      Based on the graph you sketched, for what values of $x$ is $j'(x)$ positive? You may use either inequalities or interval notation.
    \end{problem}

    \begin{solution}
      Based on the graph, $j'(x)$ is positive when $x<3$. In interval notation, $j'(x)$ is positive on the interval $(3, \infty)$.
    \end{solution}
...
\item 
  ...
  \item
    ...
    \begin{problem}[\vfill]
      ...
      (Remember the guidelines for presenting your work in such problems. If you've forgotten, look back at \href{https://canvas.harvard.edu/files/20704944/download?download_frd=1}{Problem Set 6}.)
    \end{problem}
