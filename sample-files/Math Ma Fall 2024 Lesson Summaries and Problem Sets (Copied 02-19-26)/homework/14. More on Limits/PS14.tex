...
\begin{center}
  \large\textsc{Problem Set 14 - More on Limits}
\end{center}
...
\item \label{limits-choose-graph-1}
  ...
  \item \label{limits-choose-graph-1-evaluate}
    ...
    Evaluate the following limits, showing your work or explaining your reasoning.
    ...
    \item
      ...
      \begin{solution}
        As we've seen, when taking the limit as $x \to \infty$ of a sum, we can just keep the fastest growing term (the highest power of $x$). So,
        \[
    ...
    \item
      ...
      \begin{solution}
        Direct substitution gives $\frac{2}{0}$. As $x$ approaches $1$ from the left, the numerator is positive
    ...
    \item
      ...
      \begin{solution}
        Direct substitution gives $\frac{2}{0}$. As $x$ approaches $1$ from the right, the numerator is positive
...
\item  \begin{enumerate}
  ...
  \item
    ...
    \begin{solution}
      Since $f(x) = \dfrac{x^2 - 3x - 4}{2x - 8} = \frac{1}{2}(x+1), x\neq 4$, the graph is just the graph
