...
\usepackage[grading, sols, workshop]{handout}
...
\begin{center}
  \large\textsc{Problem Set 4 - Transforming Functions}
\end{center}
...
\item 
  ...
  \begin{problem}
    Complete Practice Mini-Exam 1, and upload your work to the Gradescope assignment ``Practice Mini-Exam 1''. See more detailed instructions on the first page of the practice exam. 
  \end{problem}
...
\item  
  ...
  \begin{problem}
    If you haven't already, please talk with someone at the MQC or office hours, or get together with at least one other student outside of class sometime soon. As a reminder, we'll ask you to write a little about your experience doing this on Problem Set 6 (due Wednesday 9/20) and to share in class, so that you can hear from your peers about what different resources are like.
