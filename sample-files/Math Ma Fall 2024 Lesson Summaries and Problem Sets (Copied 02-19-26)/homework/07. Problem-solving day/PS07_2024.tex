...
\begin{center}
  \large\textsc{Problem Set 7 - Problem-solving day}\vspace{.5in}
...
\item \label{fall2015-1a-gateway-overview-25} \label{modeling-with-functions-can-1}
  ...
  \begin{problem}[\newpage]
    ...
    Whenever you do a modeling problem like this, you should follow the guidelines in \href{https://canvas.harvard.edu/files/20704944/download?download_frd=1}{Problem Set 6}:
    \begin{itemize}[nosep]
