...
\begin{center}
  \large\textsc{Problem Set 37 - Comparing Exponentials, Logarithms, and Power Functions}\vspace{.5in}\\
  \begin{problemonly}
...
\item  
  ...
  \item \label{growth-rate-limits-1}
    ...
    \item
      ...
      $e^x$. We know this because as $x \to \infty$, $e^x>>x^2$ 
        \begin{align*}
    ...
    \item
      ...
      is $2x^2$. We know this because  $e^x$ goes to 0 while $x^2$ grows in size. $x^2>>e^x$ in this instance. 
        \begin{align*}
          \lim_{x \to -\infty} \frac{x^2}{2x^2 + e^x} &= 
    ...
    \item
      ...
      \begin{solution}
        ...
        and denominator are $3e^{2x}$ and $e^{2x}$ respectively. We know this because as $x \to \infty$,  $e^{2x}>>x$, and $e^{2x}$ is the only growth term at all in the denominator.
        \begin{align*}
    ...
    \item
      ...
      \begin{solution}
        As $x\to-\infty$, the dominant terms in the numerator
        and denominator are $-x$ and $1$ respectively. $e^{2x}$ goes to 0, so $e^{2x}$ does not grow at all, while $x$ does. In this problem, $x>>e^{2x}$
        \begin{align*}
          \lim_{x \to -\infty} \frac{3 e^{2x} - x - 3}{e^{2x} + 1}
...
\item Evaluate the following limits. Again, justify your answers carefully, using correct notation.
  ...
  \item
    ...
    \begin{solution}
      As $x \to \infty$, $\sqrt[10]{x} >> \ln x$, so the dominant term in the numerator is 
      $\sqrt[10]{x}$.
      \begin{align*}
  ...
  \item
    ...
    \begin{solution}
      ...
      is $\ln x$. It is the only growth term.
      \begin{align*}
  ...
  \item
    ...
    \begin{solution}
      As $x\to\infty$, $1.01^x >> \ln x$, so the dominant term in the numerator
      is $1.01^x$.
      \begin{align*}
...
\item 
  ...
  \begin{grading}
    5 points extra credit (to be tabulated by Megan)
  \end{grading}

 
 We appreciate your time in completing this survey to help the Harvard Math Department learn more about your experience in your math class this semester. The survey should take approximately 10-15 minutes to complete.  Upon completing the survey you will have the option to opt-in to allow your responses to be included in a broader research study Harvard is involved in to understand the experiences of university students in introductory math courses.\\  

When you submit your survey you will receive (5 points extra credit on homework).  All questions are optional, but we really appreciate feedback about your experiences this past semester.  We do need you to fill in your name and HUID in order to receive credit for the survey.  Thank you in advance for your time and feedback!\\

The survey is available by clicking \href{https://harvard.az1.qualtrics.com/jfe/form/SV_1Nsxgxnt7cihAiO}{this link}:\\
