...
\begin{center}
  \large\textsc{Problem Set 19 - Maxima and Minima of Functions}
\end{center}
...
\item  \begin{grading}
  ...
  \begin{problem}
    You should now be able to \href{https://www.gradescope.com/courses/625832}{see your graded exam in Gradescope}. There is good research showing that reflecting on your work is a very effective learning strategy, so please \href{https://www.youtube.com/watch?v=TOHCkI12mh0&t=43s}{look through the feedback} on your graded exam and fill out this \href{https://forms.gle/U9qCiuiUVRpKfCWx7}{learning reflection survey}.
  \end{problem}

\end{enumerate}
\psreflection{For next class, read \href{https://people.math.harvard.edu/~jjchen/mathma/docs/handouts/Hughes-Hallet-4-2.pdf}{\S 4.2 of \emph{Calculus} by Hughes-Hallett et. al} through Example 1, or \href{https://activecalculus.org/single/sec-3-3-optimization.html}{Boelkins \S 3.3}.}
\end{document}
