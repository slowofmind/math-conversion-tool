...
\htitle{24. Derivatives of Exponential Functions}
...
\begin{framed}
  ...
  $\frac{d}{dx} e^x = \fitb{0.5in}{e^x}$.  More generally, for any
  constant $k$, $\frac{d}{dx} e^{kx} = \fitb{0.75in}{ke^{kx}}$.
\end{framed}
...
\item 
  ...
  Find the derivative of each function. You only need the Quotient Rule for 1 part! 
  \begin{enumerate}
  \item
    \begin{problem}[\vfill\newpage]
