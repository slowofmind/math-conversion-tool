...
\item \label{milk}
  ...
  \begin{problem}[\vfill]
    In a certain town in 1975, the amount of whole milk consumed by the average resident was 20 gallons (over the entire year). Since 1975, that consumption has been decreasing by $2\%$ each year. Write a formula for $M(t)$, the amount of whole milk consumed by the average resident $t$ years after 1975.
  \end{problem} 
...
\item \label{bacteria}
  ...
  \item
    ...
    \begin{problem}[\vfill\newpage]
      Write a formula for the number of bacteria in the petri dish after $d$ \uline{days}. 
    \end{problem}
