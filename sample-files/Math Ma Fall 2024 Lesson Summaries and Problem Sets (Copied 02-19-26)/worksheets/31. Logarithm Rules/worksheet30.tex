...
\item  \label{log-rules-idea}
  ...
  Here are two facts: $\log_3 4 \approx 1.26$ and $\log_3 7 \approx 1.77$. Use these two facts to help you approximate the following quantities, and explain your reasoning in each.
...
\item 
  ...
  \item
    \begin{problem}[\vfill]
      Express $\ln(w u^2)$ in terms of $A = \ln u$ and $B = \ln w$.
    \end{problem}
...
\end{enumerate}
\begin{framed}  
  \emph{Change of base to natural log}: \probonly{$\vphantom{\boxed{\int_1^2}}$}$\log_b a = \solonly{\dfrac{\ln a}{\ln b}}$
\end{framed}
