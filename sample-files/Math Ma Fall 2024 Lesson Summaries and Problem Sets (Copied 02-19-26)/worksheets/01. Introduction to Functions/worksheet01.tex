...
\htitle{Introduction to Functions}
 \begin{problemonly}
    $\bigstar$ \emph{Reminders:}
    \begin{itemize}
    \item The required algebra diagnostic is tomorrow 5:30 - 6:45 pm. If you haven't already, please sign up for Edfinity ASAP after class to make sure it works on your device.

      If your last name starts with A - M, you'll take the diagnostic in Science Center Hall C. If your last name starts with N - Z, you'll take the diagnostic in Science Center Hall A.

    \item Workshop time preferences are due today. 
    \end{itemize}
    ...
    You don't need to turn in this worksheet, so feel free to take notes on it. As you work through the problems, take some time to write down the key points you want to take away from class.

    We intentially make these worksheets too long to finish in class so that you'll always have some extra practice problems. Each section may use a slightly different worksheet; we'll post one version on the course website along with solutions. 
