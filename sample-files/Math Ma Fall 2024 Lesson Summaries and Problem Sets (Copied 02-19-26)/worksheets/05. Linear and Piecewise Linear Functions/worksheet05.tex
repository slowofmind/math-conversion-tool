...
\item  \label{thomas-wolfe}
  ...
  \item \label{thomas-wolfe-graph}
    ...
    \begin{solution} 
      \begin{center}
        \begin{tikzpicture}
          \begin{axis}[xtick={3000, 4500}, ytick={600, 1200}]
...
\item 
  ...
  \note{There's nothing new in this problem, but it's good practice if students are feeling shaky about the previous problem. If they're feeling good about the previous problem and we still have time, I might instead check in to see how they're feeling about transforming functions.}
  ...
  \item
    ...
    \begin{solution}  The function is piecewise linear
      ...
      \begin{tikzpicture}
        \begin{axis}[xmax=15.5,xtick={6,15}, ytick={60,168}]
