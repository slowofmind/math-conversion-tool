...
\htitle{2: A Library of Basic Functions and Properties}
...
\item  \label{basic-graphs-1-think-of-function}
  ...
  \item
    ...
    \begin{minipage}[t]{2.1in}
      \vspace{0pt}
      \raisebox{2ex-\height}{\includegraphics[width=2in]{images/basic-graphs-1-1}}
    \end{minipage}
    \hspace{0.25in}
  ...
  \item \label{library-|x|}
    ...
    \begin{minipage}[t]{2.1in}
      \vspace{0pt}
      \raisebox{2ex-\height}{\includegraphics[width=2in]{images/basic-graphs-1-3}}
    \end{minipage}
    \hspace{0.25in}
    \begin{minipage}[t]{\linewidth-2.45in}
      \begin{itemize}
...
\item  \label{basic-graphs-1-sketch}
  ...
  \probonly{\begin{multicols}{3}}
    ...
    \item
      ...
      \begin{solution}
        ...
        \raisebox{2ex-\height}{\includegraphics[width=2.25in]{images/basic-graphs-1-5}}
    ...
    \item
      ...
      \begin{solution}
        ...
        \raisebox{2ex-\height}{\includegraphics[width=2.25in]{images/basic-graphs-1-7}}        
    ...
    \begin{solution}
      ...
      \raisebox{2ex-\height}{\includegraphics[width=2.25in]{images/basic-graphs-1-8}}
 ...
 \item 
  ...
  \begin{problem}[\nstretch{0.5}]
    Reviewing the functions we've looked at so far, tackle this true/false.\\ True or false: If a function has a formula that looks like $f(x) = \dfrac{\text{something}}{x}$, then $f$ must have a vertical asymptote at $x = 0$. 
  \end{problem}

  \begin{solution}
    False! While vertical asymptotes occurred in $\displaystyle \frac{1}{x}$ and $\displaystyle \frac{1}{x^2}$, we saw a hole occur when looking at $\displaystyle f(x) = \frac{x^2 (x - 1)}{x - 1}$.
  \end{solution}
  \pspace{\newpage}
...
\item  \label{horizontal-asymptote-misconceptions}
  ...
  \begin{problem}
    ...
    horizontal asymptotes, which we've labeled on the graph. What are they (roughly)?
