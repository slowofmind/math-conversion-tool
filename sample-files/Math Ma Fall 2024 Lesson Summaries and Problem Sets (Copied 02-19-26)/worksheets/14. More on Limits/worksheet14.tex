...
\item  Calculate the following limits. 
  ...
  \item
    ...
    \note{Using the idea of the previous part, this is equal to $\displaystyle \lim_{x \to \infty} \dfrac{3x^2}{4x^2}$, which we can simplify using algebra.}
    ...
    \begin{solution}
      ...
      and the dominant term in the denominator is $4x^2$. This means that
      \begin{align*}
        ...
        \lim_{x \to \infty} \frac{3x^2-2x+1}{4x^2+1} &= \frac{3}{4}
      \end{align*}
    \end{solution}
  ...
  \item
    ...
    \begin{solution}
      As $x$ goes to $-\infty$, the dominant terms in the numerator and denominator are again $3x^2$ and $4x^2$,
      so
      \[\lim_{x \to -\infty} \frac{3x^2-2x+1}{4x^2+1} = \lim_{x \to -\infty} \frac{3x^2}{4x^2}=\frac{3}{4}.\]
    \end{solution}
  ...
  \item Evaluate the following limits. If the limit does not exist, can you say anything about the 1-sided limits?
    ...
    \item
      ...
      \begin{solution}
        ...
        Looking at the one-sided limits:
        \[
...
\item 
  ...
  \item
    ...
    \begin{solution}
      As $x$ goes to $\infty$, the dominant term under the radical in the denominator is $4x^2$.
      \[
