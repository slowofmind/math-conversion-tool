...
\item 
  ...
  Find the derivative of each of the following functions. You'll need to first use logarithm rules or exponential rules to rewrite the function in a form that you can differentiate.
