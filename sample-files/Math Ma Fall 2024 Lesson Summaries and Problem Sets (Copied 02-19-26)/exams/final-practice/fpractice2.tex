...
\item \points{14} 
  ...
  \item
    ...
    \item
      \begin{problem}[\vfill\newpage]
        Find $\dfrac{d}{dx} \left( \dfrac{e^{\ln 5 - 2 \ln x}}{\ln 3} \right)$
      \end{problem}

      \begin{solution}
        Again, we need to simplify the function to get it in a form we can differentiate. First, notice that the denominator is a constant, so we can rewrite this as:
        \begin{align*}
          \dfrac{e^{\ln 5 - 2 \ln x}}{\ln 3} &= \frac{1}{\ln 3} e^{\ln 5 - 2 \ln x} \\
          &= \frac{1}{\ln 3} \frac{e^{\ln 5}}{e^{2 \ln x}} \\
          &= \frac{1}{\ln 3} \frac{5}{\left( e^{\ln x} \right)^2} \\
          &= \frac{1}{\ln 3} \frac{5}{x^2} \\
          &= \frac{5}{\ln 3} x^{-2}
          \shortintertext{By the Constant Multiple Rule,}
          \dfrac{d}{dx} \left( \dfrac{e^{\ln 5 - 2 \ln x}}{\ln 3} \right) &= \frac{5}{\ln 3} (-2x^{-3}) \\
          &= \boxed{- \frac{10}{\ln 3} x^{-3}}
        \end{align*}
      \end{solution}
