...
\begin{workshop}
  Start workshop with the slides about preparing for reading period.

  After that, today's problems focus on practice with exponentials and logs, which will hopefully help students prepare for the upcoming skills check.
\end{workshop}
